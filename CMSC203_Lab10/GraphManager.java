...
public class GraphManager implements GraphManagerInterface {
	...
	GraphManager() {
		...
		function4 = new Function4(); // Elizabeth Perez added for Task #2
		function5 = new Function5(); // Elizabeth Perez added for Task #3
	}
	...
	public double getFnValue (int fnNum, double x) {
		switch(fnNum) {
			...
			case 4: return function4.fnValue(x); // Elizabeth Perez added for Task #2
			case 5: return function5.fnValue(x); // Elizabeth Perez added for Task #3
			default: return 0;
		}
	}
	...
	public Function getFunction(int choice) {
		switch(choice) {
			...
			case 4: return function4; // Elizabeth Perez added for Task #2
			case 5: return function5; // Elizabeth Perez added for Task #3
			default: return null;
		}
	}
